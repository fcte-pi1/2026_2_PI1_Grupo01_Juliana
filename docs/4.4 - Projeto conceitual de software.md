...
- **Backlog não-funcional do software:**
  ...
  - Expressões como "mais facilmente" e "mais rapidamente" são descrições subjetivas e não são requisitos não funcionais válidos. Um exemplo de requisito não funcional de desempenho é: "a página deve carregar em até 5 s em uma conexão 4G".
